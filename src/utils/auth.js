...
const authDomain = 'reactant.auth0.com'
const clientId = 'wpFoXdrinqDjG7fPC9no1VdILm5U2eaC'
    ...
    return new Promise((resolve, reject) => {
      Relay.Store.commitUpdate(
        ...
        }),
        {
          ...
          onFailure: response => {
            console.log('SinginUser error', response)
            reject(response)
          },
        }
      )
